...
smsm117.login(process.env.TOKEN);
smsm118.login(process.env.TOKEN);
smsm119.login(process.env.TOKEN);
smsm120.login(process.env.TOKEN);
smsm121.login(process.env.TOKEN);
smsm122.login(process.env.TOKEN);
smsm123.login(process.env.TOKEN);
